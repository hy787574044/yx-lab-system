...
INSERT INTO lab_sample (id, sample_no, seal_no, task_id, point_id, point_name, sample_type, detection_items, detection_type_id, detection_type_name, detection_config_snapshot, review_flow_id, review_flow_name, sampling_time, seal_time, sampler_id, sampler_name, weather, storage_condition, sample_status, result_summary, remark, trace_log, deleted, created_by, created_name, created_time, updated_by, updated_name, updated_time)
VALUES
(770001, 'SAMPLE-DEMO-001', 'SEAL-DEMO-001', 760001, 740001, '城东水厂出厂水', 'FACTORY', '出厂水常规九项', 720001, '出厂水常规九项', NULL, 9601, '常规三级审核', NOW() - INTERVAL 18 DAY, NOW() - INTERVAL 18 DAY + INTERVAL 2 HOUR, 1101, '陈采样', '晴', '冷藏避光', 'COMPLETED', '正常', '演示：已完成并生成报告。', '样品登录：封签号=SEAL-DEMO-001，采样员=陈采样\n审查通过：结果=正常\n已生成报告', 0, 1101, '陈采样', NOW() - INTERVAL 18 DAY + INTERVAL 2 HOUR, 1301, '刘审核', NOW() - INTERVAL 17 DAY),
(770002, 'SAMPLE-DEMO-002', 'SEAL-DEMO-002', 760002, 740002, '城西水厂出厂水', 'FACTORY', '出厂水常规九项', 720001, '出厂水常规九项', NULL, 9601, '常规三级审核', NOW() - INTERVAL 13 DAY, NOW() - INTERVAL 13 DAY + INTERVAL 2 HOUR, 1102, '李采样', '多云', '常温送检', 'COMPLETED', '正常', '演示：已发布报告。', '样品登录：封签号=SEAL-DEMO-002，采样员=李采样\n审查通过：结果=正常\n已发布报告', 0, 1102, '李采样', NOW() - INTERVAL 13 DAY + INTERVAL 2 HOUR, 1401, '孙报告', NOW() - INTERVAL 12 DAY),
(770003, 'SAMPLE-DEMO-003', 'SEAL-DEMO-003', 760003, 740003, '富河原水取水口', 'RAW', '原水重点五项', 720002, '原水重点五项', NULL, 9601, '常规三级审核', NOW() - INTERVAL 9 DAY, NOW() - INTERVAL 9 DAY + INTERVAL 2 HOUR, 1101, '陈采样', '小雨', '冷藏送检', 'REVIEWING', '异常', '演示：检测已提交，待审核。', '样品登录：封签号=SEAL-DEMO-003，采样员=陈采样\n检测提交：结果=异常', 0, 1101, '陈采样', NOW() - INTERVAL 9 DAY + INTERVAL 2 HOUR, 1202, '赵检测', NOW() - INTERVAL 8 DAY),
(770004, 'SAMPLE-DEMO-004', 'SEAL-DEMO-004', 760004, 740004, '兴国大道末梢点', 'TERMINAL', '管网末梢四项', 720003, '管网末梢四项', NULL, 9601, '常规三级审核', NOW() - INTERVAL 6 DAY, NOW() - INTERVAL 6 DAY + INTERVAL 2 HOUR, 1102, '李采样', '晴', '常温送检', 'RETEST', '余氯：低于控制要求', '演示：审核驳回，待重检。', '样品登录：封签号=SEAL-DEMO-004，采样员=李采样\n审查驳回：余氯偏低，要求复检', 0, 1102, '李采样', NOW() - INTERVAL 6 DAY + INTERVAL 2 HOUR, 1302, '何审核', NOW() - INTERVAL 5 DAY),
(770005, 'SAMPLE-DEMO-005', 'SEAL-DEMO-005', 760005, 740001, '城东水厂出厂水', 'FACTORY', '出厂水常规九项', 720001, '出厂水常规九项', NULL, 9601, '常规三级审核', NOW() - INTERVAL 3 DAY, NOW() - INTERVAL 3 DAY + INTERVAL 2 HOUR, 1101, '陈采样', '晴', '冷藏避光', 'LOGGED', NULL, '演示：待分配检测人员。', '样品登录：封签号=SEAL-DEMO-005，采样员=陈采样', 0, 1101, '陈采样', NOW() - INTERVAL 3 DAY + INTERVAL 2 HOUR, 1101, '陈采样', NOW() - INTERVAL 3 DAY + INTERVAL 2 HOUR),
(770006, 'SAMPLE-DEMO-006', 'SEAL-DEMO-006', 760006, 740004, '兴国大道末梢点', 'TERMINAL', '管网末梢四项', 720003, '管网末梢四项', NULL, 9601, '常规三级审核', NOW() - INTERVAL 2 DAY, NOW() - INTERVAL 2 DAY + INTERVAL 2 HOUR, 1102, '李采样', '阴', '常温送检', 'LOGGED', NULL, '演示：已分配，待检测。', '样品登录：封签号=SEAL-DEMO-006，采样员=李采样\n检测分样：已分配检测人员', 0, 1102, '李采样', NOW() - INTERVAL 2 DAY + INTERVAL 2 HOUR, 1203, '周检测', NOW() - INTERVAL 2 DAY + INTERVAL 3 HOUR);
