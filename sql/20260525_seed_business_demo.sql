...
INSERT INTO lab_sampling_task (
    ...
    sample_type, sample_register_status, sample_id, detection_items, task_status,
...
VALUES
(960001, 'TASK-202605-0001', 'YX202605250001', 950001, 940001, '城东水厂出厂水', DATE_SUB(NOW(), INTERVAL 4 DAY), 1101, '陈采样', 'FACTORY', 'REGISTERED', 970001, 'pH,浊度,余氯', 'COMPLETED', DATE_SUB(NOW(), INTERVAL 4 DAY), '现场指标：温度18.2，余氯0.48', '晴', '18.2', 'http://192.168.7.24:9010/resource/demo/photo-0001.jpg,http://192.168.7.24:9010/resource/demo/photo-0002.jpg', NULL, DATE_SUB(NOW(), INTERVAL 4 DAY), '演示：任务已完成并回填样品。', 0, 1101, '陈采样', NOW() - INTERVAL 4 DAY, 1101, '陈采样', NOW() - INTERVAL 3 DAY),
(960002, 'TASK-202605-0002', NULL, 950001, 940001, '城东水厂出厂水', DATE_SUB(NOW(), INTERVAL 3 DAY), 1101, '陈采样', 'FACTORY', 'UNREGISTERED', NULL, 'pH,浊度,余氯', 'IN_PROGRESS', DATE_SUB(NOW(), INTERVAL 3 DAY), '现场指标：温度19.1，浊度略高', '多云', '19.1', 'http://192.168.7.24:9010/resource/demo/photo-0003.jpg', NULL, NULL, '演示：执行中任务。', 0, 1101, '陈采样', NOW() - INTERVAL 3 DAY, 1101, '陈采样', NOW() - INTERVAL 2 DAY),
(960003, 'TASK-202605-0003', NULL, 950002, 940002, '城西水厂出厂水', DATE_SUB(NOW(), INTERVAL 7 DAY), 1102, '李采样', 'FACTORY', 'UNREGISTERED', NULL, 'pH,浊度,色度', 'ABANDONED', NULL, NULL, NULL, NULL, NULL, '现场道路施工，无法到达点位。', NULL, '演示：废弃任务。', 0, 1102, '李采样', NOW() - INTERVAL 7 DAY, 1102, '李采样', NOW() - INTERVAL 6 DAY),
(960004, 'TASK-202605-0004', NULL, 950003, 940003, '富河原水取水口', DATE_SUB(NOW(), INTERVAL 6 DAY), 1101, '陈采样', 'RAW', 'UNREGISTERED', NULL, 'pH,浊度,氨氮,高锰酸盐指数', 'PENDING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '演示：待处理任务。', 0, 1101, '陈采样', NOW() - INTERVAL 6 DAY, 1101, '陈采样', NOW() - INTERVAL 5 DAY),
(960005, 'TASK-202605-0005', 'YX202605250002', 950004, 940004, '兴国大道管网末梢', DATE_SUB(NOW(), INTERVAL 2 DAY), 1102, '李采样', 'TERMINAL', 'REGISTERED', 970002, 'pH,浊度,余氯,肉眼可见物', 'COMPLETED', DATE_SUB(NOW(), INTERVAL 2 DAY), '现场指标：余氯0.03，需复核', '晴', '23.5', 'http://192.168.7.24:9010/resource/demo/photo-0004.jpg', NULL, DATE_SUB(NOW(), INTERVAL 2 DAY), '演示：已完成并登录样品。', 0, 1102, '李采样', NOW() - INTERVAL 2 DAY, 1102, '李采样', NOW() - INTERVAL 1 DAY),
(960006, 'TASK-202605-0006', NULL, 950005, 940005, '莲花湖社区末梢点', DATE_ADD(NOW(), INTERVAL 2 DAY), 1101, '陈采样', 'TERMINAL', 'UNREGISTERED', NULL, 'pH,浊度,余氯', 'PENDING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '演示：未发布计划对应任务。', 0, 1101, '陈采样', NOW() - INTERVAL 1 DAY, 1101, '陈采样', NOW() - INTERVAL 1 DAY),
(960007, 'TASK-202605-0007', NULL, 950006, 940006, '应急加密监测点', DATE_SUB(NOW(), INTERVAL 1 DAY), 1102, '李采样', 'RAW', 'UNREGISTERED', NULL, 'pH,浊度,氨氮', 'IN_PROGRESS', DATE_SUB(NOW(), INTERVAL 1 DAY), '现场指标：温度21.0，天气闷热', '阴', '21.0', 'http://192.168.7.24:9010/resource/demo/photo-0005.jpg', NULL, NULL, '演示：进行中任务。', 0, 1102, '李采样', NOW() - INTERVAL 1 DAY, 1102, '李采样', NOW()),
(960008, 'TASK-202605-0008', 'YX202605250003', 950006, 940006, '应急加密监测点', DATE_SUB(NOW(), INTERVAL 8 DAY), 1102, '李采样', 'RAW', 'REGISTERED', 970003, 'pH,浊度,氨氮', 'COMPLETED', DATE_SUB(NOW(), INTERVAL 8 DAY), '现场指标：异常复核样', '阴', '20.6', 'http://192.168.7.24:9010/resource/demo/photo-0006.jpg', NULL, DATE_SUB(NOW(), INTERVAL 8 DAY), '演示：重检关联任务。', 0, 1102, '李采样', NOW() - INTERVAL 8 DAY, 1102, '李采样', NOW() - INTERVAL 7 DAY);
...
VALUES ('20260525', 6)
ON DUPLICATE KEY UPDATE current_value = GREATEST(current_value, VALUES(current_value)), updated_time = NOW();
...
VALUES
(980001, 970001, 'YX202605250001', 720001, '出厂水常规九项', NULL, NULL, NULL, NULL, NULL, 'WAIT_ASSIGN', 0, 1101, '陈采样', NOW() - INTERVAL 4 DAY, 1101, '陈采样', NOW() - INTERVAL 4 DAY),
(980002, 970002, 'YX202605250002', 720003, '管网末梢四项', DATE_SUB(NOW(), INTERVAL 2 DAY), 1201, '王检测', NULL, NULL, 'WAIT_DETECT', 0, 1102, '李采样', NOW() - INTERVAL 2 DAY, 1201, '王检测', NOW() - INTERVAL 2 DAY),
(980003, 970003, 'YX202605250003', 720004, '应急复检套牌', DATE_SUB(NOW(), INTERVAL 8 DAY), 1202, '赵检测', 'ABNORMAL', '浊度和氨氮超出控制要求，待复核。', 'SUBMITTED', 0, 1102, '李采样', NOW() - INTERVAL 8 DAY, 1202, '赵检测', NOW() - INTERVAL 8 DAY),
(980004, 970004, 'YX202605250004', 720002, '原水重点五项', DATE_SUB(NOW(), INTERVAL 5 DAY), 1203, '周检测', 'NORMAL', '全部指标正常。', 'APPROVED', 0, 1101, '陈采样', NOW() - INTERVAL 5 DAY, 1203, '周检测', NOW() - INTERVAL 4 DAY),
(980005, 970005, 'YX202605250005', 720001, '出厂水常规九项', NULL, NULL, NULL, NULL, NULL, 'WAIT_DETECT', 0, 1101, '陈采样', NOW() - INTERVAL 1 DAY, 1101, '陈采样', NOW() - INTERVAL 1 DAY),
(980006, 970006, 'YX202605250006', 720002, '原水重点五项', DATE_SUB(NOW(), INTERVAL 6 DAY), 1202, '赵检测', 'ABNORMAL', '原水氨氮偏高，待复审。', 'REJECTED', 0, 1102, '李采样', NOW() - INTERVAL 6 DAY, 1202, '赵检测', NOW() - INTERVAL 5 DAY);
...
VALUES
(800001, 980003, 970003, 'YX202605250003', @reviewFlowId, @reviewNodeId, @reviewNodeName, @reviewNodeOrder, @reviewRequiredFlag, 1301, '刘审核', DATE_SUB(NOW(), INTERVAL 7 DAY), 'APPROVED', NULL, '第一节点审核通过。', 0, 1301, '刘审核', NOW() - INTERVAL 7 DAY, 1301, '刘审核', NOW() - INTERVAL 7 DAY),
(800002, 980006, 970006, 'YX202605250006', @reviewFlowId, @reviewNodeId, @reviewNodeName, @reviewNodeOrder, @reviewRequiredFlag, 1302, '何审核', DATE_SUB(NOW(), INTERVAL 4 DAY), 'REJECTED', '氨氮超限，建议重检。', '已要求重检。', 0, 1302, '何审核', NOW() - INTERVAL 4 DAY, 1302, '何审核', NOW() - INTERVAL 4 DAY);
...
VALUES
(810001, 'YX202605250004-检测报告草稿', 'DAILY', DATE_SUB(NOW(), INTERVAL 5 DAY), 970004, 'YX202605250004', 980004, 'DRAFT', NULL, NULL, NULL, NULL, '样品编号：YX202605250004；点位：富河原水取水口；检测结果：正常；说明：草稿状态演示。', 0, 1301, '刘审核', NOW() - INTERVAL 5 DAY, 1301, '刘审核', NOW() - INTERVAL 5 DAY),
(810002, 'YX202605250003-检测报告已生成', 'DAILY', DATE_SUB(NOW(), INTERVAL 4 DAY), 970003, 'YX202605250003', 980003, 'GENERATED', NULL, NULL, NULL, '/home/resource/report/YX202605250003.pdf', '样品编号：YX202605250003；点位：应急加密监测点；检测结果：异常；说明：已生成未发布。', 0, 1301, '刘审核', NOW() - INTERVAL 4 DAY, 1301, '刘审核', NOW() - INTERVAL 4 DAY),
(810003, 'YX202605250004-检测报告正式版', 'DAILY', DATE_SUB(NOW(), INTERVAL 3 DAY), 970004, 'YX202605250004', 980004, 'PUBLISHED', DATE_SUB(NOW(), INTERVAL 2 DAY), 1401, '孙报告', '/home/resource/report/YX202605250004.pdf', '样品编号：YX202605250004；点位：富河原水取水口；检测结果：正常；说明：正式发布演示。', 0, 1301, '刘审核', NOW() - INTERVAL 3 DAY, 1401, '孙报告', NOW() - INTERVAL 2 DAY);
...
VALUES
(820001, 810003, 970004, 'YX202605250004', 1401, '孙报告', '13810004001', 'UNIFIED', 'SUCCESS', '报告已成功推送。', DATE_SUB(NOW(), INTERVAL 2 DAY), 0, 1401, '孙报告', NOW() - INTERVAL 2 DAY, 1401, '孙报告', NOW() - INTERVAL 2 DAY),
(820002, 810002, 970003, 'YX202605250003', 1401, '孙报告', '13810004001', 'UNIFIED', 'PENDING', '等待推送。', NULL, 0, 1401, '孙报告', NOW() - INTERVAL 4 DAY, 1401, '孙报告', NOW() - INTERVAL 4 DAY),
(820003, 810001, 970004, 'YX202605250004', 1401, '孙报告', '13810004001', 'UNIFIED', 'CANCELLED', '推送已撤回。', DATE_SUB(NOW(), INTERVAL 3 DAY), 0, 1401, '孙报告', NOW() - INTERVAL 3 DAY, 1401, '孙报告', NOW() - INTERVAL 3 DAY),
(820004, 810003, 970004, 'YX202605250004', 1401, '孙报告', '13810004001', 'UNIFIED', 'FAILED', '推送失败，稍后重试。', DATE_SUB(NOW(), INTERVAL 2 DAY), 0, 1401, '孙报告', NOW() - INTERVAL 2 DAY, 1401, '孙报告', NOW() - INTERVAL 2 DAY);
...
(850002, '采样编号管理制度', '管理制度', 'docx', 143360, '/home/resource/docs/sample-no-management.docx', '演示文档。', 0, 1001, '系统管理员', NOW() - INTERVAL 18 DAY, 1001, '系统管理员', NOW() - INTERVAL 1 DAY),
